...
export default function CTA() {
  return (
    <section id="contact" className="relative py-20 sm:py-32 bg-gray-50 border-t border-border overflow-hidden">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          <FadeIn>
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-black mb-6 sm:mb-8 leading-tight">
            ...
            <div className="bg-white p-6 sm:p-8 border border-border">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 mb-6">
                 ...
                 <div>
                    ...
                    <p className="font-serif text-2xl sm:text-3xl text-black mb-2">Торнев Юрий Михайлович</p>
              ...
              <div className="pt-4 border-t border-border">
                <a href="tel:89215883309" className="inline-block text-accent hover:text-black transition-colors text-lg sm:text-xl font-medium border-b border-accent/20 hover:border-black pb-1">8-921-588-33-09</a>
              </div>
            </div>
          </FadeIn>

          <FadeIn delay={0.2}>
            <form className="space-y-6 sm:space-y-8 bg-white p-6 sm:p-10 md:p-12 border border-border shadow-2xl shadow-gray-200/50 relative">
              ...
              <div className="space-y-1">
                ...
                <input 
                  type="text" 
                  className="w-full border-b border-gray-300 py-3 text-black outline-none focus:border-accent transition-colors bg-transparent placeholder-gray-300 font-light text-sm sm:text-base"
              ...
              <div className="space-y-1">
                ...
                <textarea 
                  rows={3}
                  className="w-full border-b border-gray-300 py-3 text-black outline-none focus:border-accent transition-colors bg-transparent placeholder-gray-300 font-light resize-none text-sm sm:text-base"
              ...
              <button 
                type="button" 
                className="w-full py-4 sm:py-5 bg-black text-white hover:bg-accent transition-colors duration-300 text-xs sm:text-sm font-medium uppercase tracking-widest"
              >
                Отправить заявку
              </button>
